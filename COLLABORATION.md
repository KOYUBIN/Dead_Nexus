...
| ⚔ **RPG — ASH & SIGNAL** | `rpg/` | 신설 (이번 스트레치에 0→완성형) | 미션 30종 · 4클래스 · 4엔딩+NG+ · Act 2 4갈래+캡스톤 · 장비/인텔 경제 · 아이소 뷰 · 픽셀 아트 · 사운드 |
...
## 2. 진행 로그 (v6.26 → v6.44, 2026-07-17 ~ 07-21)

...
**현재 버전**: v3.2 (2026-05-18) — BROKER 너프 + CARBON 활성화

- **11×11 정식**: **모든 임계 통과 ✅** (BROKER 17.6%, CARBON 10%, 평균 10R, 폭주 0건)
- **5×5 튜토리얼**: 거의 완벽 (AXIOM 0% 경고만 잔여)
- v3.1 TM 스타일 마일스톤+어워드 시스템 안정화

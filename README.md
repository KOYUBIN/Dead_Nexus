...
**DEAD NEXUS**는 5인 전략 레거시 보드게임 프로젝트입니다.  
사이버펑크 디스토피아 도시 **애시그리드(Ashgrid)**를 무대로, 5대 블록(Bloc) 메가기업과 독립 고스트(Ghost)가 벌이는 권력·자원·정보 전쟁을 다룹니다.
...
|---|---|
| **플레이 인원** | 2–5명 |
| **플레이 타임** | 120–180분 (단판) / 레거시 캠페인 8~12 세션 |
| **추천 연령** | 16세 이상 |
| **난이도** | ★★★★★ |
...
### 🔄 v0.3 — 카드 데이터 (진행 중)
- [x] Bloc 전용 액션카드 30장 (5 × 6)
- [ ] Ghost 클래스별 10장 덱 × 6클래스 = 60장
- [ ] 뉴스 이벤트 카드 50장
- [ ] 블랙마켓 덱 30장
- [ ] 퀘스트 카드 40장

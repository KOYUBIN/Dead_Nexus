...
**현재 버전**: v3.0 (2026-05-14) — headless/simulator 코드 분기 통합 + v2.4 밸런스 너프 (DRIFTER/Bloc 능동 카드/자산 임계)

- 11×11 정식: Ghost 43–50% / Bloc 50–57%, 평균 5.75R (200판) — 거의 통과
- 5×5 튜토리얼: Ghost 40.5% / Bloc 59.5% (개선 중)

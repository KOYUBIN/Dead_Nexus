...
**현재 버전**: v3.1 (2026-05-18) — Terraforming Mars 스타일 마일스톤+어워드 시스템 도입

- **5×5 튜토리얼**: Ghost 49% / Bloc 51%, 평균 7R (200판) — **모든 임계 통과 ✅**
- **11×11 정식**: 거의 완벽 (BROKER 70.6% 폭주만 잔여), 평균 10R
- 즉시 승리 임계 폐지 → maxRounds 도달 시 점수 합산식 (Bloc 자산÷7 / Ghost 평판+레이드×3 + 마일스톤/어워드)

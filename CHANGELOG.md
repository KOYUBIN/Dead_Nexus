...
| mfg | 제조 | **코드 (Code)** | 동시대 다른 IP/Rigger | 💾 |
...
- **신규** `docs/17-v1.0-systems.md` — v0.6~v1.0 시스템 통합 정리
  ...
  - 시그널 점진 공개형 시그널 / 건물 / 하이라이트 / mini-raid / Bloc 능동 / 방어 비용
  - 5×5 vs 11×11 비교표
  - 게임 모드 (솔로/핫시트/봇 시뮬)
...
## [0.6.3d] — 시그널 점진 공개형 시그널 시스템 (NPC 블록 정보 점진 공개) (2026-04-27)
...
### Removed
- 동시대 다른 IP, Cyberware, Night City, ICE, MegaCorp 등 저작권 위험 용어

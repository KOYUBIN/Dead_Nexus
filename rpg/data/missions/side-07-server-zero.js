;(function () {
  ...
  var COMBAT = {
    ...
    //   [65차 밸런스] 코어 앞 랙 차폐물 (1,3)/(4,3) → (0,3)/(5,3) 측벽 재배치 — 엄폐는 이동
    //   차단이므로 (1,3) 배치가 좌측 벽(1,2)·드론(0,2)과 겹쳐 저HACK 러시 클래스(BROKER)의
    //   좌측 접근 레인을 봉쇄 + 엄폐 미끼로 전진을 교착시켰다(clearFail). 측벽 이동으로
    //   레인 개방 · 엄폐 기능(랙 차폐 4기) 유지.
    cover: [
      { x: 0, y: 3, type: 'full'  }, { x: 5, y: 3, type: 'full'  },

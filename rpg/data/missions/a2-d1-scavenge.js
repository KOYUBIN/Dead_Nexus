;(function () {
  ...
  var COMBAT = {
    ...
    walls: [
      ...
      // [71차 L5] 관제 단말 앞 붕괴 잔해 2개 — 트리비얼 이상치(BLADE 2R 무피해 러시) 해소 레버.
      //   코어(3,0)는 이미 그리드 최원거리라 이설 불가 → 코어 앞 직선 진입만 막아 우회(x=4 레인)를
      //   강제한다. 실측 파급: 이 미션 2셀만 변동(BLADE 2R→3R · MOLE 2R→3R) · 신규 이상치 0.
      { x: 2, y: 1 }, { x: 3, y: 1 },
    ],
